...
export default function ArticleAuthor() {
    return (
        <section
            ...
            className="flex items-start gap-4 sm:gap-5 rounded-2xl border border-beige/15 bg-beige/[0.03] p-5 sm:p-6"
        >
            <div
                className="flex h-12 w-12 sm:h-14 sm:w-14 shrink-0 items-center justify-center rounded-full bg-beige font-mono text-lg sm:text-xl font-bold text-background"
                aria-hidden="true"
            >
                G/
            </div>
